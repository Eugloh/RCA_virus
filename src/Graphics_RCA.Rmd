...
baseDir <- "/home/lohmanne/TARIK/RCA_virus"
SourceDir <- "/home/lohmanne/TARIK/RCA_virus/src"
OutputDir <- "/home/lohmanne/TARIK/RCA_virus/plot"
DataDir <- "/home/lohmanne/TARIK/RCA_virus/data"
...
shinyApp(
  ...
  #Widgets 
    sidebarPanel(
      ...
      checkboxInput("checkboxNa", "Include NA", value = TRUE),
  ...
  #Widget change seuil max = nombre individus du re-echantillonnage
    output$slider_num <- renderUI({sliderInput("hist_num", width = "100%",
                  ...
                  min=1, max=20000, step=1, value=2)})
  #Graphique creation
...
shinyApp(
  ...
  ui = fluidPage(
    ...
    sidebarPanel(
        h2(strong("Options :")),
        selectizeInput("taxon_input", h4("Taxon desire:"), taxons, width="100%",
                    multiple=F,selected="Viruses"),
        width=3),
    #barplot
    mainPanel(plotlyOutput("barplot"),width=9),
    mainPanel(plotlyOutput("boxplot"),width = 9)
  ...
  server = function(input, output) {
    ...
    output$barplot <- renderPlotly({
      ...
      p <- ggplot(data_graphe, aes(x=variable,y=value,key=key)) + geom_col(fill="steelblue")  + 
        ...
        xlab("Echantillons") + ylab("Nombre d'individus (Abondance)") + ggtitle(paste("Composition en ",input$taxon_input,"\ndes differents echantillons", sep=""))
