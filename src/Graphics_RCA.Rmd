...
packages=c("optparse","rlist","tidyverse","scales","reshape2","ggplot2","stringr","dplyr","tidyr")
  ...
  #Widgets 
    sidebarPanel(
      ...
      selectInput("taxon_radio", width = "100%",
                  ...
                  choices=list("Species"=0,"Family"=1,"Subkingdom"=2,"genus"=3,selected = 1),
