...
shinyApp(
  ...
  #Widgets 
    sidebarPanel(
      ...
      selectInput("taxon_radio", width = "100%",
                  ...
                  choices=list("Description"=0,"order"=1,"family"=2,"genus"=3,"species"=4),selected = 3),

      checkboxInput("checkbox", "Stacked", value = FALSE),
  ...
  #Widget change seuil max = nombre individus du re-echantillonnage
    output$slider_num <- renderUI({sliderInput("hist_num", width = "100%",
                  ...
                  min=1, max=input$sample_num, step=1, value=2)})
  #Graphique creation
  ...
  {if(input$checkbox)geom_bar(position="fill",stat="identity")}+
  {if(input$checkbox==FALSE)geom_bar(stat="identity")}+
